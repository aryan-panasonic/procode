          ...
          {steps.map((step, i) => (
            <React.Fragment key={i}>
              <div style={{flex: "1 1 150px", textAlign: "center"}}>
                <div style={{width: "60px", height: "60px", borderRadius: "50%", background: "var(--cyan-pale)", color: "var(--cyan)", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 1rem", fontSize: "1.2rem", fontWeight: 600, border: "1px solid var(--cyan)"}}>
                  {i + 1}
                </div>
